...
router.patch("/updateprofile",protect,UserController.updateUserProfile)
router.patch("/updateprofilepicture",protect,upload.single("image"),UserController.updateUserProfilePicture)
